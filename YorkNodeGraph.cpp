...
//
//static std::vector<YorkNode*> s_nodes;
//
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
///*
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//static bool isConnectorHovered(YorkConnection* c, ImVec2 offset)
//{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//static YorkConnection* getHoverCon(ImVec2 offset, ImVec2* pos)
//{
//	for (YorkNode* node : s_nodes)
//	{
//		ImVec2 nodePos = node->pos + offset;
//
//		for (YorkConnection* con : node->inputConnections)
//		{
...
//		}
//
//		for (YorkConnection* con : node->outputConnections)
//		{
//			if (isConnectorHovered(con, nodePos))
//			{
//				*pos = nodePos + con->pos;
...
//	{
//		ImVec2 pos;
//		YorkConnection* con = getHoverCon(offset, &pos);
//
//		if (con)
//		{
//			s_dragNode.con = con;
...
//
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//static void displayNode(ImDrawList* drawList, ImVec2 offset, YorkNode* node, int& node_selected)
//{
...
//		ImGui::Text("%s", con->description.name);
//
...
//	for (YorkConnection* con : node->outputConnections)
//	{
//		textSize = ImGui::CalcTextSize(con->description.name);
//
...
//}
//
//YorkNode* findNodeByCon(YorkConnection* findCon)
//{
//	for (YorkNode* node : s_nodes)
//	{
//		for (YorkConnection* con : node->inputConnections)
...
//				continue;
//
//			YorkNode* targetNode = findNodeByCon(con->input);
//
//			if (!targetNode)
//				continue;
//
...
//	if (!ImGui::Begin("YorkNodeGraph", opened))
//	{
//		ImGui::End();
//		return;
//	}
...
//			{
//				YorkNode* node = YorkNode::createNode(ImGui::GetIO().MousePos, &s_nodeTypes[i]);
